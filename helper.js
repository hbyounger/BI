...
function $templateCache(e) {
    ...
    e.put("/static/js/dashboard/tpl/chart-edit.html",
        <div class="chart-edit-layer" bindonce="i18nLoaded">\r
            <div class="view-header J_view_header">\r
                <a class="back-btn J-create-chart-ok-button" bo-title="'done' | translate" ng-click="verifyChartArgs()">\r
                    <i class="bdp-icon ico-back"></i>\r
                </a>\r
                <div class="view-header-seperate-line"></div>\r
